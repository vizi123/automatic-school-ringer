...
void ringOreLungi() {
  ...
  if (h == 10 && m == 35 && s >= 0 && s <= 3)
    ring();
  if (h == 10 && m == 40 && s >= 0 && s <= 3)
    ring();
  if (h == 11 && m == 25 && s >= 0 && s <= 3)
    ring();
  if (h == 11 && m == 30 && s >= 0 && s <= 3)
    ring();
  if (h == 12 && m == 10 && s >= 0 && s <= 3)
    ring();
  if (h == 12 && m == 15 && s >= 0 && s <= 3)
    ring();
  if (h == 13 && m == 10 && s >= 0 && s <= 3)
    ring();
  if (h == 13 && m == 15 && s >= 0 && s <= 3)
    ring();
  if (h == 14 && m == 00 && s >= 0 && s <= 3)
    ring();
  if (h == 14 && m == 05 && s >= 0 && s <= 3)
    ring();
  if (h == 14 && m == 55 && s >= 0 && s <= 3)
    ring();
